...
- !policy
  id: $BRANCH_NAME
  body:
    # Grant the automation workload host the ability to read and update
    # secrets (variables) within this branch. Adjust privileges to taste.
    - !permit
      role: !host /$WORKLOAD_HOST
